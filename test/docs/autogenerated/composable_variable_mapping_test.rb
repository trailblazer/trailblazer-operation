...
class CVInjectPassAggregateTest < DocsTest
  ...
  it "Inject() with {:pass_aggregate}" do
    assert_invoke Memo::Operation::Create, current_user: Module, expected_ctx_variables: {model: Object, action_in_check: "Module/admin/:edit"}

    # Inject(:action) is not called as it's present in input.
    assert_invoke Memo::Operation::Create, current_user: Module, action: ":create", expected_ctx_variables: {model: Object, action_in_check: ":create"}
  end
end
...
class Out_PassAggregateTest < DocsTest
  ...
  it "Out() with {:pass_aggregate} and {:with_outer_ctx}" do
    assert_invoke Memo::Operation::Create, params: [], expected_ctx_variables: {:aggregate_inspect=>"{}", :outer_ctx_inspect=>"{:seq=>[], :params=>[]}", :params_inspect=>"[]"}
  end
end
...
class In_PassAggregateTest < DocsTest
  ...
  it "In() with {:pass_aggregate}" do
    assert_invoke Memo::Operation::Create, params: [], model: Object, expected_ctx_variables: {:aggregate_inspect=>"{:model=>Object}", :params_inspect=>"[]"}
  end
end
