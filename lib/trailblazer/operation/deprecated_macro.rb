...
module Trailblazer
  module Operation::DeprecatedMacro
    ...
    def self.call(proc, options)
      ...
      wrapped_proc = ->((proc_options, flow_options), **circuit_options) do
        result = proc.(circuit_options[:exec_context], proc_options) # run the macro, with the deprecated signature.
